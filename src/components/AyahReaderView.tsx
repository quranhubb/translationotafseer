...
export const AyahReaderView: React.FC<AyahReaderViewProps> = ({
  ...
  return (
    ...
    >
      {/* Top Header Bar matching Rich Gold theme */}
      <div className="bg-[#7D6B4B] text-white sticky top-0 z-30 shadow-sm border-b border-[#63553C]">
          ...
          <div className="flex items-center gap-0.5">
            ...
            <button
              ...
              className={`p-2 rounded-full transition-all cursor-pointer relative ${
                isAnnotating
                  ? 'bg-[#524631] text-amber-300 ring-2 ring-[#C5A059]'
            ...
            <button
              ...
              className={`p-2 rounded-full text-white transition-all cursor-pointer ${
                isPlaying ? 'bg-[#524631] ring-1 ring-[#C5A059]' : 'hover:bg-[#63553C]'
              }`}
        ...
        <div
          ref={tabsScrollRef}
          className="flex items-center overflow-x-auto scrollbar-none px-2 border-t border-[#63553C] bg-[#63553C] text-xs font-medium text-[#F3E7C4]"
        >
          {surahAyahs.map((a) => {
            ...
            return (
              <button
                ...
                className={`py-2 px-3.5 whitespace-nowrap transition-all font-arabic text-sm cursor-pointer ${
                  isSelected
                    ? 'active-tab text-white font-bold border-b-2 border-[#C5A059] bg-[#524631]'
                    : 'text-[#F3E7C4]/80 hover:text-white hover:bg-[#7D6B4B]'
                }`}
              >
      ...
      <div className="max-w-xl mx-auto p-3.5 space-y-3.5">
        ...
        >
          ...
          <div className="flex items-center justify-between pb-3 border-b border-[#E5DFCE] text-xs text-[#8C7D63] font-sans relative z-10">
            ...
            <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
              ...
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-xs font-medium flex items-center gap-1.5 transition-all cursor-pointer ${
                  isAnnotating
                    ...
                    : 'bg-[#F5EFE2] hover:bg-[#ECE4D0] text-[#7D6B4B] border border-[#E5DFCE]'
                }`}
                title="Pencil, Highlighter & Eraser"
              >
              ...
              <button
                ...
                className="p-1 text-[#8C7D63] hover:text-[#7D6B4B] transition-colors cursor-pointer"
                title="Copy Ayah"
              >
          ...
          <div className="relative flex items-center justify-center my-4">
            <div className="border-t border-[#E5DFCE] w-full" />
            <div className="absolute bg-[#7D6B4B] text-white px-3.5 py-0.5 text-xs font-bold rounded-full font-sans tracking-widest uppercase shadow-2xs border border-[#63553C]">
          ...
          {settings.showWordByWord && currentAyah.words && currentAyah.words.length > 0 && (
            <div
              ...
              className="my-4 p-3.5 sm:p-4 bg-[#FAF7EE] rounded-2xl border border-[#E5DFCE] shadow-2xs"
            >
              {/* Header with Quick Language Switch */}
              <div className="flex items-center justify-between pb-2.5 mb-3 border-b border-[#E5DFCE]">
              ...
              <div className="flex flex-wrap items-stretch justify-center gap-2 sm:gap-2.5 dir-rtl text-center">
                {currentAyah.words.map((w, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col items-center justify-between p-2 sm:p-2.5 rounded-xl bg-[#FFFFFF] border border-[#E5DFCE] min-w-[70px] max-w-[120px] shadow-2xs hover:bg-[#FAF7EE] hover:border-[#7D6B4B]/50 transition-all group"
                  >
                    {/* Arabic word */}
          ...
          <div className="space-y-3 my-4">
            ...
            {(settings.primaryTranslation === 'en' || settings.primaryTranslation === 'both') && (
              <div className="p-3.5 bg-[#FFFFFF] rounded-xl border border-[#E5DFCE] text-left dir-ltr shadow-2xs">
                <div className="flex items-center justify-between mb-1.5 pb-1 border-b border-[#E5DFCE]/60">
                  <span className="text-[10px] bg-[#8C7A58] text-white px-2 py-0.5 rounded font-sans font-bold uppercase tracking-wider">
            ...
            {(settings.primaryTranslation === 'ur' || settings.primaryTranslation === 'both') && (
              <div className="p-3.5 bg-[#FFFFFF] rounded-xl border border-[#E5DFCE] text-right dir-rtl shadow-2xs">
                <div className="flex items-center justify-between mb-1.5 pb-1 border-b border-[#E5DFCE]/60">
          ...
          <div className="mt-5 pt-4 border-t border-dashed border-[#D5CDBC]">
            ...
            {(settings.tafseerLang === 'en' || settings.tafseerLang === 'both') && (
              <div className="text-left text-sm leading-relaxed text-[#2D2D2D] bg-[#FAF7EE] p-4 rounded-xl border border-[#E5DFCE] font-sans shadow-2xs">
                <div className="text-[10px] bg-[#8C7A58] text-white px-2 py-0.5 rounded font-sans font-bold uppercase tracking-wider inline-block mb-2.5">
            ...
            {(settings.tafseerLang === 'ur' || settings.tafseerLang === 'both') && (
              <div className="mt-3 font-urdu text-right dir-rtl text-[15px] leading-[2.3] text-[#2D2D2D] bg-[#FAF7EE] p-4 rounded-xl border border-[#E5DFCE] shadow-2xs">
                <div className="text-[11px] bg-[#7D6B4B] text-white px-2 py-0.5 rounded font-urdu font-bold inline-block mb-2 border border-[#63553C]">
        ...
        <div className="flex items-center justify-between gap-3 pt-2">
          <button
            ...
            className="flex-1 bg-[#FFFFFF] hover:bg-[#F5EFE2] text-[#2D2D2D] font-bold py-3 px-4 rounded-xl border border-[#E5DFCE] shadow-xs flex items-center justify-center gap-2 active:scale-95 transition-all cursor-pointer font-sans"
          >
      ...
      {isPlaying && (
        <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-[#524631] text-[#FCFAF5] px-3.5 py-2 z-40 shadow-2xl flex items-center justify-between rounded-t-xl border-t border-[#C5A059]/40">
          <div className="flex items-center gap-2">
            <div className="w-7 h-7 rounded-full bg-[#7D6B4B] border border-[#C5A059]/50 flex items-center justify-center animate-pulse">
          ...
          <div className="flex items-center gap-1.5">
            ...
            <button
              onClick={togglePlayAudio}
              className="w-7 h-7 rounded-full bg-[#7D6B4B] hover:bg-[#63553C] text-[#F3E7C4] border border-[#C5A059]/50 flex items-center justify-center cursor-pointer"
            >
      ...
      {showNextAyahPrompt && currentAyah.surahNumber === 2 && currentAyah.ayahNumber <= 141 && currentAyah.ayahNumber > 1 && (
        <div className="fixed inset-0 bg-black/45 backdrop-blur-xs z-50 flex items-center justify-center p-4">
          <div className="bg-[#FCFAF5] border-2 border-[#7D6B4B] rounded-2xl max-w-md w-full p-5 shadow-2xl text-center space-y-4 animate-in fade-in zoom-in duration-200">
            <div className="w-12 h-12 rounded-full bg-[#7D6B4B]/15 text-[#7D6B4B] flex items-center justify-center mx-auto shadow-inner border border-[#7D6B4B]/30">
              <Sparkles className="w-6 h-6 text-[#C5A059]" />
            </div>
            <div className="space-y-1.5">
              <span className="text-[11px] font-bold text-[#7D6B4B] uppercase tracking-wider bg-[#F5EFE2] border border-[#E5DFCE] px-3 py-1 rounded-full font-sans">
              ...
              <p className="text-sm font-urdu text-[#8C7D63] leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 pt-2">
              ...
              <button
                ...
                className="flex-1 bg-[#ECE4D0] hover:bg-[#DFD5BE] text-[#2D2D2D] font-semibold py-2.5 px-3 rounded-xl transition-all font-urdu text-sm cursor-pointer"
              >
